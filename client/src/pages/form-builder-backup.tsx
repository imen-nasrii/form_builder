...
export default function FormBuilderFixed() {
  ...
  const createDefaultField = (componentType: string): FormField => {
    ...
    // Component templates based on exact specifications provided by user
  ...
  const removeChildField = (parentId: string, childFieldId: string) => {
    setFormData(prev => ({
      ...prev,
      fields: prev.fields.map(field => {
        if (field.Id === parentId && field.ChildFields) {
          return {
            ...field,
