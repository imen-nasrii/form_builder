                ...
                {editingComponent && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4 md:col-span-2">
                      <h3 className={`text-lg font-semibold ${isDarkMode ? 'text-white' : ''}`}>Validation & Behavior</h3>
                    ...
                    {(editingComponent.type === 'RADIOGRP' || editingComponent.type === 'LSTLKP' || editingComponent.type === 'CHECKBOX') && (
                      <div className="space-y-4 md:col-span-2">
                        <h3 className={`text-lg font-semibold ${isDarkMode ? 'text-white' : ''}`}>Options</h3>
                    ...
                    {/* CSS Classes & Styling */}
                    <div className="space-y-4 md:col-span-2">
                      <h3 className={`text-lg font-semibold ${isDarkMode ? 'text-white' : ''}`}>Custom Styling</h3>
