...
import FormBuilderFinal from "@/pages/form-builder-final";
    ...
    <Switch>
      {!isAuthenticated ? (
        ...
        <>
          ...
          <Route path="/form-builder" component={FormBuilderFinal} />
          <Route path="/form-builder/:formId" component={FormBuilderFinal} />
