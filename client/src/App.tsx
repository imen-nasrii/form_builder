...
import FormBuilderClean from "@/pages/form-builder";
    ...
    <Switch>
      {!isAuthenticated ? (
        ...
        <>
          ...
          <Route path="/form-builder" component={FormBuilderClean} />
          <Route path="/form-builder/:formId" component={FormBuilderClean} />
