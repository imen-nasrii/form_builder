...
import FormBuilderSimple from "@/pages/form-builder-simple";
    ...
    <Switch>
      {!isAuthenticated ? (
        ...
        <>
          ...
          <Route path="/form-builder" component={FormBuilderSimple} />
          <Route path="/form-builder/:formId" component={FormBuilderSimple} />
