...
import FormBuilderCleanFinal from "@/pages/form-builder-clean-final";
    ...
    <Switch>
      {!isAuthenticated ? (
        ...
        <>
          ...
          <Route path="/form-builder" component={FormBuilderCleanFinal} />
          <Route path="/form-builder/:formId" component={FormBuilderCleanFinal} />
