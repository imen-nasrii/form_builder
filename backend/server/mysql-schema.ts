...
// Form definitions table for MySQL
...
// Form templates table for MySQL
...
// User sessions and 2FA tokens for MySQL
...
// All the validation operators and field types (same as main schema)
